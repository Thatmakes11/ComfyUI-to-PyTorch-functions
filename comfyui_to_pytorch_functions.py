...
class CodeGenerator:
    ...
    def generate_workflow(
        ...
        final_code = self.assemble_python_code(
            import_statements, special_functions_code, code, custom_nodes, task
        )
...
class ComfyUItoPython:
    ...
    def execute(self):
        ...
        generated_code = code_generator.generate_workflow(load_order, task=self.task)
